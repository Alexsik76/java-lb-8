# Завдання обов’язкове до здачі! Необхідно реалізувати одну з задач.

## Варіант 1. Обчислення наближеного значення числа Пі методом ***Монте-Карло***

У цьому завданні вам слід написати паралельну програму, яка обчислює значення числа Пі. Метод обчислення дуже простий:
...
Деталі реалізації Ваше завдання написати паралельну реалізацію ```ParallelMonteCarloPi.java```. 
...
```aiignore
PI is 3.14221 
THREADS 8 ITERATIONS 1,000,000,000 
TIME 12.83ms
```
